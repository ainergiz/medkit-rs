...
pub use sampler::{
    ...
    CachedImageVolume, CachedPatch, ChunkedCachedCase, ForegroundPrefix, LoadedCachedCase,
    MmapCachedCase, PatchRecord, SampleConfig, SampleSummary, SamplingStrategy,
};
