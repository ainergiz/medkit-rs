...
pub use pixel::{
    ...
    present_dicom_pixels_with_options, DecodedPixelData, DecoderBackend, DicomDecoderSelection,
    DicomPresentationOptions, DicomRsDecoderBackend, DicomVoiStrategy, NativeDecoderBackend,
    PixelExplanation, PresentedImage,
};
